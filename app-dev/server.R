...
#
# ## seasonStandings ----
season_standings_ds <- open_dataset(
  # "https://raw.githubusercontent.com/tylerpollard410/nfl-analysis-app/main/data/season_standings_data/",
  "~/Desktop/nflanalysisapp/data/season_standings_data",
  format = "parquet"
)
...
shinyServer(function(input, output, session) {
  ...
  mod_standings_server(
    "standings",
    teamsData = teamsData,
    season_standings_ds = season_standings_ds
  )
